...
import(
  ...
  "net/http"
  "strconv"
  "golangcity.com/golangcity/pkg/forms"
...
func (app *application) createPost(w http.ResponseWriter, r *http.Request) {
  ...
  form.Required("title", "content", "code")
  ...
  id, err := app.posts.Insert(form.Get("title"), form.Get("content"), form.Get("code"))
  if err != nil {
    app.serverError(w, err)
    return
  }
